...
class NewBenefitClassSetup(
    ...
    class MetaOapg:
        ...
        class properties:
            benefitClassSetupEffectiveDate = schemas.DateSchema
            benefitClass = schemas.StrSchema
            benefitSalary = schemas.NumberSchema
            benefitSalaryEffectiveDate = schemas.DateSchema
            doNotApplyAdministrativePeriod = schemas.BoolSchema
            measureACAEligibility = schemas.BoolSchema
            __annotations__ = {
                "benefitClassSetupEffectiveDate": benefitClassSetupEffectiveDate,
    ...
    benefitClassSetupEffectiveDate: MetaOapg.properties.benefitClassSetupEffectiveDate
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["benefitClassSetupEffectiveDate"]) -> MetaOapg.properties.benefitClassSetupEffectiveDate: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["benefitClassSetupEffectiveDate", "benefitClass", "benefitSalary", "benefitSalaryEffectiveDate", "doNotApplyAdministrativePeriod", "measureACAEligibility", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["benefitClassSetupEffectiveDate"]) -> MetaOapg.properties.benefitClassSetupEffectiveDate: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["benefitClassSetupEffectiveDate", "benefitClass", "benefitSalary", "benefitSalaryEffectiveDate", "doNotApplyAdministrativePeriod", "measureACAEligibility", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        benefitClassSetupEffectiveDate: typing.Union[MetaOapg.properties.benefitClassSetupEffectiveDate, str, date, ],
        ...
        benefitSalaryEffectiveDate: typing.Union[MetaOapg.properties.benefitSalaryEffectiveDate, str, date, schemas.Unset] = schemas.unset,
