...
class NewAdditionalDirectDeposit(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accountType", "routingNumber", "accountNumber", "amountType", "amount", "blockSpecial", "nameOnAccount", "skipPreNote", "preNoteDate", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["accountType", "routingNumber", "accountNumber", "amountType", "amount", "blockSpecial", "nameOnAccount", "skipPreNote", "preNoteDate", ], str]):
