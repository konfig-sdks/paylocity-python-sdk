...
class NonPrimaryStateTax(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            reciprocityCode = schemas.DictSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["reciprocityCode"]) -> MetaOapg.properties.reciprocityCode: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["amount", "deductionsAmount", "dependentsAmount", "exemptions", "exemptions2", "filingStatus", "higherRate", "otherIncomeAmount", "percentage", "reciprocityCode", "specialCheckCalc", "taxCalculationCode", "taxCode", "w4FormYear", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["reciprocityCode"]) -> typing.Union[MetaOapg.properties.reciprocityCode, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["amount", "deductionsAmount", "dependentsAmount", "exemptions", "exemptions2", "filingStatus", "higherRate", "otherIncomeAmount", "percentage", "reciprocityCode", "specialCheckCalc", "taxCalculationCode", "taxCode", "w4FormYear", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        reciprocityCode: typing.Union[MetaOapg.properties.reciprocityCode, dict, frozendict.frozendict, schemas.Unset] = schemas.unset,
