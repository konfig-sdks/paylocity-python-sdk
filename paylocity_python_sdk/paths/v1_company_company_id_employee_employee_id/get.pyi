...
from paylocity_python_sdk.model.employee_v1 import EmployeeV1 as EmployeeV1Schema
from paylocity_python_sdk.model.errors import Errors as ErrorsSchema

from paylocity_python_sdk.type.employee_v1 import EmployeeV1
from paylocity_python_sdk.type.errors import Errors

from ...api_client import Dictionary
from paylocity_python_sdk.pydantic.employee_v1 import EmployeeV1 as EmployeeV1Pydantic
...
SchemaFor200ResponseBodyApplicationJson = EmployeeV1Schema
    ...
    async def _aget_employee_data_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/company/{companyId}/employee/{employeeId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetEmployeeData(BaseApi):
    ...
    async def aget_employee_data(
        ...
        **kwargs,
        ...
        if validate:
            return EmployeeV1Pydantic(**raw_response.body)
        return api_client.construct_model_instance(EmployeeV1Pydantic, raw_response.body)
