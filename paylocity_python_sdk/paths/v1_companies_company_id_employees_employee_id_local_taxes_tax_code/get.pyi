...
SchemaFor200ResponseBodyApplicationJson = LocalTaxSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_for_tax_code_mapped_args(
        self,
        company_id: str,
        employee_id: str,
        tax_code: str,
    ...
    async def _aget_for_tax_code_oapg(
        self,
...
class GetForTaxCodeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_for_tax_code(
        self,
        company_id: str,
        employee_id: str,
        tax_code: str,
        **kwargs,
        ...
        args = self._get_for_tax_code_mapped_args(
            company_id=company_id,
            employee_id=employee_id,
            tax_code=tax_code,
        )
        return await self._aget_for_tax_code_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_for_tax_code(
        self,
        company_id: str,
        employee_id: str,
        tax_code: str,
        ...
        return self._get_for_tax_code_oapg(
            path_params=args.path,
        )

class GetForTaxCode(BaseApi):
    ...
    async def aget_for_tax_code(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_for_tax_code(
            company_id=company_id,
            employee_id=employee_id,
            tax_code=tax_code,
            **kwargs,
        ...
        if validate:
            return LocalTaxPydantic(**raw_response.body)
        return api_client.construct_model_instance(LocalTaxPydantic, raw_response.body)
    ...
    def get_for_tax_code(
        ...
        raw_response = self.raw.get_for_tax_code(
            company_id=company_id,
            employee_id=employee_id,
            tax_code=tax_code,
        )
