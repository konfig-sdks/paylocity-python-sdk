...
from paylocity_python_sdk.model.deduction import Deduction as DeductionSchema
from paylocity_python_sdk.model.errors import Errors as ErrorsSchema

from paylocity_python_sdk.type.deduction import Deduction
from paylocity_python_sdk.type.errors import Errors

from ...api_client import Dictionary
from paylocity_python_sdk.pydantic.deduction import Deduction as DeductionPydantic
...
request_path_deduction_code = api_client.PathParameter(
    name="deductionCode",
    style=api_client.ParameterStyle.SIMPLE,
...
SchemaFor200ResponseBodyApplicationJson = DeductionSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_by_code_mapped_args(
        ...
        if deduction_code is not None:
            _path_params["deductionCode"] = deduction_code
        args.path = _path_params
        return args

    async def _aget_by_code_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/companies/{companyId}/employees/{employeeId}/deductions/{deductionCode}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetByCodeRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_by_code(
        self,
        company_id: str,
        employee_id: str,
        deduction_code: str,
        **kwargs,
        ...
        args = self._get_by_code_mapped_args(
            company_id=company_id,
            employee_id=employee_id,
            deduction_code=deduction_code,
        )
        return await self._aget_by_code_oapg(
    ...
    def get_by_code(
        ...
        return self._get_by_code_oapg(
            path_params=args.path,
        )

class GetByCode(BaseApi):
    ...
    async def aget_by_code(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_by_code(
            company_id=company_id,
            employee_id=employee_id,
            deduction_code=deduction_code,
            **kwargs,
        ...
        if validate:
            return DeductionPydantic(**raw_response.body)
        return api_client.construct_model_instance(DeductionPydantic, raw_response.body)
    ...
    def get_by_code(
        ...
        raw_response = self.raw.get_by_code(
            company_id=company_id,
            employee_id=employee_id,
            deduction_code=deduction_code,
        )
