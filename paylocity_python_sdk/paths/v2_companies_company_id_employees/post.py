...
from paylocity_python_sdk.model.employee_add_to_paylocity_response import EmployeeAddToPaylocityResponse as EmployeeAddToPaylocityResponseSchema
...
from paylocity_python_sdk.model.employee_add_to_paylocity500_response import EmployeeAddToPaylocity500Response as EmployeeAddToPaylocity500ResponseSchema
...
from paylocity_python_sdk.model.employee_add_to_paylocity400_response import EmployeeAddToPaylocity400Response as EmployeeAddToPaylocity400ResponseSchema
...
from paylocity_python_sdk.type.employee_add_to_paylocity_response import EmployeeAddToPaylocityResponse
...
from paylocity_python_sdk.type.employee_add_to_paylocity500_response import EmployeeAddToPaylocity500Response
from paylocity_python_sdk.type.employee_add_to_paylocity400_response import EmployeeAddToPaylocity400Response
...
from paylocity_python_sdk.pydantic.employee_add_to_paylocity_response import EmployeeAddToPaylocityResponse as EmployeeAddToPaylocityResponsePydantic
...
from paylocity_python_sdk.pydantic.employee_add_to_paylocity500_response import EmployeeAddToPaylocity500Response as EmployeeAddToPaylocity500ResponsePydantic
...
from paylocity_python_sdk.pydantic.employee_add_to_paylocity400_response import EmployeeAddToPaylocity400Response as EmployeeAddToPaylocity400ResponsePydantic
...
SchemaFor201ResponseBodyApplicationJson = EmployeeAddToPaylocityResponseSchema


@dataclass
class ApiResponseFor201(api_client.ApiResponse):
    body: EmployeeAddToPaylocityResponse
...
SchemaFor400ResponseBodyApplicationJson = EmployeeAddToPaylocity400ResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: EmployeeAddToPaylocity400Response
...
SchemaFor500ResponseBodyApplicationJson = EmployeeAddToPaylocity500ResponseSchema


@dataclass
class ApiResponseFor500(api_client.ApiResponse):
    body: EmployeeAddToPaylocity500Response
...
class BaseApi(api_client.Api):
    ...
    def _add_to_paylocity_mapped_args(
        self,
        company_id: str,
    ...
    async def _aadd_to_paylocity_oapg(
        self,
...
class AddToPaylocityRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_to_paylocity(
        self,
        company_id: str,
        additional_direct_deposit: typing.Optional[EmployeeAdditionalDirectDeposit] = None,
        additional_rate: typing.Optional[EmployeeAdditionalRate] = None,
        ...
        **kwargs,
        ...
        args = self._add_to_paylocity_mapped_args(
        ...
        return await self._aadd_to_paylocity_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def add_to_paylocity(
        self,
        company_id: str,
        additional_direct_deposit: typing.Optional[EmployeeAdditionalDirectDeposit] = None,
        additional_rate: typing.Optional[EmployeeAdditionalRate] = None,
        ...
        return self._add_to_paylocity_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddToPaylocity(BaseApi):
    ...
    async def aadd_to_paylocity(
        ...
        validate: bool = False,
        **kwargs,
    ) -> EmployeeAddToPaylocityResponsePydantic:
        raw_response = await self.raw.aadd_to_paylocity(
            company_id=company_id,
            additional_direct_deposit=additional_direct_deposit,
            additional_rate=additional_rate,
            benefit_setup=benefit_setup,
        ...
        if validate:
            return RootModel[EmployeeAddToPaylocityResponsePydantic](raw_response.body).root
        return api_client.construct_model_instance(EmployeeAddToPaylocityResponsePydantic, raw_response.body)
    ...
    def add_to_paylocity(
        ...
        raw_response = self.raw.add_to_paylocity(
            company_id=company_id,
            additional_direct_deposit=additional_direct_deposit,
            additional_rate=additional_rate,
            benefit_setup=benefit_setup,
