...
from paylocity_python_sdk.model.local_taxes_add_new_tax_response import LocalTaxesAddNewTaxResponse as LocalTaxesAddNewTaxResponseSchema
from paylocity_python_sdk.model.local_taxes_add_new_tax500_response import LocalTaxesAddNewTax500Response as LocalTaxesAddNewTax500ResponseSchema

from paylocity_python_sdk.type.local_tax import LocalTax
from paylocity_python_sdk.type.local_taxes_add_new_tax500_response import LocalTaxesAddNewTax500Response
from paylocity_python_sdk.type.local_taxes_add_new_tax_response import LocalTaxesAddNewTaxResponse

from ...api_client import Dictionary
from paylocity_python_sdk.pydantic.local_taxes_add_new_tax_response import LocalTaxesAddNewTaxResponse as LocalTaxesAddNewTaxResponsePydantic
from paylocity_python_sdk.pydantic.local_tax import LocalTax as LocalTaxPydantic
from paylocity_python_sdk.pydantic.local_taxes_add_new_tax500_response import LocalTaxesAddNewTax500Response as LocalTaxesAddNewTax500ResponsePydantic
...
SchemaFor400ResponseBodyApplicationJson = LocalTaxesAddNewTaxResponseSchema


@dataclass
class ApiResponseFor400(api_client.ApiResponse):
    body: LocalTaxesAddNewTaxResponse
...
SchemaFor500ResponseBodyApplicationJson = LocalTaxesAddNewTax500ResponseSchema


@dataclass
class ApiResponseFor500(api_client.ApiResponse):
    body: LocalTaxesAddNewTax500Response
...
class AddNewTaxRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aadd_new_tax(
        self,
        company_id: str,
        employee_id: str,
        exemptions: typing.Optional[typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]] = None,
        ...
        **kwargs,
        ...
        args = self._add_new_tax_mapped_args(
        ...
        return await self._aadd_new_tax_oapg(
            body=args.body,
    ...
    def add_new_tax(
        ...
        return self._add_new_tax_oapg(
            body=args.body,
            path_params=args.path,
        )

class AddNewTax(BaseApi):
    ...
    async def aadd_new_tax(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aadd_new_tax(
            company_id=company_id,
            employee_id=employee_id,
            exemptions=exemptions,
            exemptions2=exemptions2,
    ...
    def add_new_tax(
        ...
        raw_response = self.raw.add_new_tax(
            company_id=company_id,
            employee_id=employee_id,
            exemptions=exemptions,
            exemptions2=exemptions2,
