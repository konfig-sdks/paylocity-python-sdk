...
class RequiredNewAdditionalDirectDeposit(TypedDict):
    pass

class OptionalNewAdditionalDirectDeposit(TypedDict, total=False):
...
class NewAdditionalDirectDeposit(RequiredNewAdditionalDirectDeposit, OptionalNewAdditionalDirectDeposit):
    pass
